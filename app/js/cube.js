    ...
    for(var y = 1; y <= 3; y++) {
      for(var x = 1; x <= 3; x++) {
        ...
        if($isNewGame) {
          ...
          // Add the cube's coordinates to its class name
          // Add the cube's coordinates and all of its pyramids' data to its own data
        ...
        // If the player has a game save
          ...
          // And add the cube and its pyramids their corresponding data following the same pattern as above
          ...
          if(stickerData) {
            ...
            if(stickerData.front) {
              ...
              frontPyramid.addClass(getOrientation(stickerCoord)+" sticker"+stickerCoord);
            }
            ...
            if(stickerData.back) {
              ...
              backPyramid.addClass(getOrientation(stickerCoord)+" sticker"+stickerCoord);
            }
            ...
            if(stickerData.top) {
              ...
              topPyramid.addClass(getOrientation(stickerCoord)+" sticker"+stickerCoord);
            }
            ...
            if(stickerData.bottom) {
              ...
              bottomPyramid.addClass(getOrientation(stickerCoord)+" sticker"+stickerCoord);
            }
            ...
            if(stickerData.left) {
              ...
              leftPyramid.addClass(getOrientation(stickerCoord)+" sticker"+stickerCoord);
            }
            ...
            if(stickerData.right) {
              ...
              rightPyramid.addClass(getOrientation(stickerCoord)+" sticker"+stickerCoord);
            }
          }
        }
...
function randomizeCube() {
  ...
  var delay = 150; // For the animation, delay between each turn
